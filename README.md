...
| папка | что внутри |
|-------|------------|
| [`program/`](program/) | дуга шести элементов, недели, форматы, что участник выносит |
| [`principles/`](principles/) | как устроена работа: отсечение, открытая сборка, ритуал завершения сессии, человек в контуре |
| [`skills/research/`](skills/research/) | обезличенный скилл `/research` — методология exa-first исследования с оценкой доказательств |
...
| [`STYLE.md`](STYLE.md) | визуальная грамматика shaper: как оформляются все артефакты репозитория |
