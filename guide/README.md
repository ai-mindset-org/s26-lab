...
|---|--------|---------------|--------|
| 01 | [минимальный старт](01-start.md) | сразу, первые 15 минут | рабочий |
| 02 | [карта источников](02-sources.md) | когда первый источник собран | рабочий |
| 03 | [хранение слоями](03-layers.md) | когда файлов стало больше десятка | рабочий |
| 04 | [волт: типы, имена, поиск](04-vault.md) | когда перестал находить своё | рабочий |
| 05 | [грабли](05-rakes.md) | прочитать заранее, вернуться при боли | рабочий |
| 06 | [безопасность контекста](06-security.md) | до первой отправки во внешний сервис | рабочий |
| 07 | [примеры](07-examples.md) | когда непонятно, как это выглядит у людей | рабочий |
| 08 | [поколения метода](08-generations.md) | когда нашёл материалы прошлых потоков | рабочий |
| 09 | [механика срабатывания](09-gates.md) | когда правила записаны и продолжают нарушаться | рабочий · схема в работе |
| 10 | [что не сработало](10-failures.md) | до того, как начнёшь наводить порядок в собранном | рабочий · схема в работе |

«рабочий» значит: текст полный, читать и применять можно. открытые места названы внутри разделов прямо — там, где механики нет, так и написано.
...
репозиторий публичный, поэтому гайд прошёл проверку на то, что можно отдавать наружу:

| проверка | результат |
|---|---|
| внутренние адреса, ключи, токены | не найдено |
| имена машин и служебных сервисов | не найдено |
| личные имена в цитатах участников | все цитаты по роли, без имён |
| внутренние пути и названия репозиториев | не найдено |
| самораскрытие инцидентов с персональными данными | обезличено до механики |
| содержимое закрытого контура | отсутствует |

имена в гайде есть только у авторов — ниже, и это их согласие.
